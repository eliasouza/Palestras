...
\def\mytitle{Fundamentos}

% Tema da apresentação
\def\mysubject{Programando Para Arduino} 

% Local da apresentação
\def\myinstitute{Faculdades Integradas de Caratinga - FIC} 

% Programa da apresentação
\def\myprogram{Curso de Graduação em Engenharia Elétrica} 
...
% ----- Logo nas páginas --------% 
\pgfdeclareimage[width=0.7cm]{logo}{img/doctum.png}
